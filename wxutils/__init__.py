...
from .colors import (COLORS, GUI_COLORS, GUIColors,
                     ...
                     ColorScheme, DisabledColorScheme, CheckedColorScheme, TextScheme, ComboScheme, ScrollBarScheme, SplitterScheme, RadioDotScheme, ToggleScheme, IconScheme, ProgressScheme, DialogScheme, TabScheme, MenuBarScheme, SyntaxScheme)
